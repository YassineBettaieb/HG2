...
import { NavigationAs } from "./components/Assistant/navigation";
import { HeaderAs } from "./components/Assistant/header";
import { FeaturesAs } from "./components/Assistant/features";
import { AboutAs } from "./components/Assistant/about";
import { ServicesAs } from "./components/Assistant/services";
import { GalleryAs } from "./components/Assistant/gallery";
import { TestimonialsAs } from "./components/Assistant/testimonials";
import { TeamAs } from "./components/Assistant/Team";
import { ContactAs } from "./components/Assistant/contact";
import {AssistantEditProfile} from "./components/Assistant/AssistantEditProfile";
import AssistantManageProfile from "./components/Assistant/AssistantManageProfile";
...
import RegisterAs from "./components/Assistant/RegisterAs";
import { ProfileAs } from "./components/Assistant/profileAs";
...
<Route
          ...
          element={
            <>
              <NavigationAs />
              <HeaderAs data={landingPageData.HeaderAs} />
              <FeaturesAs data={landingPageData.FeaturesAs} />
              <AboutAs data={landingPageData.AboutAs} />
              <ServicesAs data={landingPageData.ServicesAs} />
              <GalleryAs data={landingPageData.GalleryAs} />
              <TestimonialsAs data={landingPageData.TestimonialsAs} />
              <TeamAs data={landingPageData.TeamAs} />
              <ContactAs data={landingPageData.ContactAs} />
...
<Route
        ...
        <Route path="/ProfileAs" element={<ProfileAs />} />
