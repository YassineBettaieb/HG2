...
const ManageBarbers = () => {
  ...
  const [selectedAssistants, setSelectedAssistants] = useState(null);
  ...
  <div className="modal">
    <div className="modal-content">
      ...
      <div className="form-group">
        <button
          onClick={() => {
            handleDelete(barberToDelete.id);
            setBarberToDelete(null); // <-- clear after deletion
          }}
        >
          Yes, Delete
        </button>
        <button
          onClick={() => {
            setShowConfirmDelete(false);
            setBarberToDelete(null); // <-- clear cancel state
          }}
        >
          Cancel
        </button>
  ...
  <div className="modal">
    <div className="modal-content">
      ...
      <div className="form-group">
        ...
        <input
          type="text"
          value={editingBarber.location}
          onChange={(e) =>
            setEditingBarber({ ...editingBarber, location: e.target.value })
          }
        />
      </div>
      ...
      <div className="form-group">
        ...
        <input
          type="number"
          value={editingBarber.latitude}
          onChange={(e) =>
            setEditingBarber({ ...editingBarber, latitude: e.target.value })
          }
        />
      </div>
      <div className="form-group">
        ...
        <input
          type="number"
          value={editingBarber.longitude}
          onChange={(e) =>
            setEditingBarber({ ...editingBarber, longitude: e.target.value })
          }
        />
      </div>
      ...
      <div className="form-group">
        ...
        <input
          type="text"
          value={editingBarber.services?.join(", ") || ""}
          onChange={(e) =>
            setEditingBarber({
              ...editingBarber,
      ...
      {selectedBarber && (
        <div className="modal" onClick={() => setSelectedBarber(null)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <h4>Assistants:</h4>
            <ul>
              {(dummyAssistants[selectedBarber.id] || []).length > 0 ? (
                dummyAssistants[selectedBarber.id].map((a) => (
                  <li key={a.id}>
